...
async function migrateNotifications() {
  ...
  console.log('[Migration] Conectado a MySQLalianza_salud...');

  // 1. Tabla notification_settings
  await conn.query(`
  ...
  console.log('[Migration] Tablas de notificaciones creadas e inicializadas exitosamente.');
  await conn.end();
}
