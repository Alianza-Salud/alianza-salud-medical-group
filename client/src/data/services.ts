...
/**
 * Datos mock centralizados de servicios jurídicos.
 *
 * En fases futuras, estos datos serán reemplazados por consultas
 * al backend: GET /api/services y GET /api/services/:slug.
 *
 * NOTA: El contenido es informativo y placeholder.
 * No constituye asesoramiento legal definitivo.
 */
export const services: Service[] = [
  {
    ...
    icon: 'Stethoscope',
    situations: [
      'Diagnósticos presuntamente errados o tardíos',
      'Errores presuntos durante procedimientos quirúrgicos',
      'Administración inadecuada de medicamentos',
      'Falta de seguimiento post-operatorio',
      'Infecciones asociadas a la atención en salud',
      'Alta prematura sin evaluación completa',
    ],
    processSteps: [
      'Evaluación inicial gratuita de su caso',
      'Revisión de la historia clínica y documentación',
  ...
  },
  {
    ...
    icon: 'ShieldCheck',
    situations: [
      'Daños derivados de tratamientos médicos',
      'Complicaciones no informadas al paciente',
      'Falta de consentimiento informado',
      'Demoras injustificadas en la atención',
      'Deficiencias en la prestación del servicio de salud',
      'Responsabilidad institucional de clínicas y hospitales',
    ],
    processSteps: [
      'Consulta inicial para conocer su situación',
      'Recopilación de documentación clínica',
      'Evaluación médica por especialistas',
      'Dictamen jurídico sobre viabilidad',
      'Inicio de acciones legales si procede',
  ...
  },
  {
    ...
    icon: 'Car',
    situations: [
      'Colisiones vehiculares con lesiones personales',
      'Atropellamientos',
      'Accidentes en motocicleta',
      'Accidentes con vehículos de transporte público',
      'Siniestros con daños materiales y personales',
      'Fallecimiento como consecuencia de un accidente vial',
    ],
    processSteps: [
      'Atención inmediata de su caso',
      'Recopilación de evidencias y documentación',
      'Evaluación médica de las lesiones',
      'Análisis de responsabilidad',
      'Gestión de reclamaciones',
      'Representación legal y seguimiento',
    ],
  ...
  },
  {
    ...
    icon: 'Scale',
    situations: [
      'Lesiones personales con incapacidad temporal o permanente',
    ...
    processSteps: [
      ...
      'Cálculo de la indemnización potencial',
      'Negociación con las partes responsables',
      'Proceso judicial si es necesario',
  ...
  },
  {
    ...
    icon: 'HeartPulse',
    situations: [
      'Resultados no conformes con lo pactado',
      'Complicaciones post-operatorias por presunta mala praxis',
      'Falta de consentimiento informado adecuado',
      'Procedimientos realizados por personal no cualificado',
      'Infecciones o daños derivados del procedimiento',
      'Publicidad engañosa sobre procedimientos estéticos',
    ],
    processSteps: [
      'Análisis de la documentación previa al procedimiento',
      'Evaluación del consentimiento informado',
      'Valoración médica especializada del resultado',
      'Determinación de la viabilidad jurídica',
  ...
  },
  {
    ...
    icon: 'Briefcase',
    situations: [
      'Casos de responsabilidad civil relacionados con salud',
      'Reclamaciones ante entidades de salud',
      'Casos de derechos del paciente',
      'Situaciones no contempladas en las categorías anteriores',
    ],
    processSteps: [
      'Contacto inicial para describir su situación',
