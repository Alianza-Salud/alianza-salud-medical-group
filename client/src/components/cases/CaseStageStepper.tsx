  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between text-xs font-semibold">
        <span className="text-gray-500 uppercase tracking-wider">Etapa del Proceso Pericial ({activeIdx + 1} de {CASE_STAGES.length})</span>
      ...
      {/* Stepper visual en grid adaptable */}
        ...
        {CASE_STAGES.map((stage, idx) => {
          ...
          return (
            ...
            >
              <div
                className={cn(
                  'flex h-5 w-5 items-center justify-center rounded-full text-[10px] font-bold mb-1',
              ...
              {isCurrent && (
                <span className="mt-1 inline-flex items-center gap-0.5 text-[8px] text-primary font-semibold">
                  <Clock className="h-2 w-2" /> Activa
                </span>
              )}
            </button>
          );
